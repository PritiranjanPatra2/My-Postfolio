    ...
    <>
      <div className="About-page">
        <div className="text-content">
          ...
          <p>
            Hi Everyone, I am{" "}
            <a href="https://github.com/PritiranjanPatra2">Pritiranjan Patra</a>{" "}
            from{" "}
            <a href="https://en.wikipedia.org/wiki/Bhubaneswar">
              Bhubaneswar, India.
            </a>
            <br />I have completed Integrated MCA (IMCA) at Utkal University.
          </p>
          <p>Apart from coding, some other activities that I love to do!</p>
          <ul>
            <li>Debugging code at 2 AM like a true night owl 🦉</li>
            <li>Googling error messages like it's a daily ritual 🔍💻</li>
            <li>Travelling... to Stack Overflow and back ✈️😂</li>
          </ul>

          <p className="quote">
            "I don’t fix bugs, I just turn them into features. 😎"
          </p>
      ...
      <div className="tools-section">
        <h2>
          Tools I <span className="highlight">Use</span>
        </h2>
        <div className="tools">
          <div className="tool">
            <SiWindows className="icon" />
            <span>Windows</span>
          </div>
          <div className="tool">
      ...
      <div className="coding-days-section">
        <h2>
          Days I <span className="highlight">Code</span>
        </h2>
